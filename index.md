...
- [func HashReader\(r io.Reader\) \(string, error\)](<#HashReader>)
...
- [func NormalizeModelIdentity\(repoName string\) string](<#NormalizeModelIdentity>)
...
- [func RemoveEvalBundleAtomic\(modelsPath, repoID string\) error](<#RemoveEvalBundleAtomic>)
...
- [type DiscoveredEval](<#DiscoveredEval>)
  - [func DiscoverPrimary\(ctx context.Context, client EvalHubClient, repoID string\) \(\*DiscoveredEval, error\)](<#DiscoverPrimary>)
  - [func DiscoverSecondary\(ctx context.Context, client EvalHubClient, repoID string\) \(\*DiscoveredEval, error\)](<#DiscoverSecondary>)
...
- [type EvalAuthority](<#EvalAuthority>)
- [type EvalDestination](<#EvalDestination>)
  - [func ResolveEvalDestination\(modelsPath, repositoryID string\) \(EvalDestination, error\)](<#ResolveEvalDestination>)
- [type EvalHubClient](<#EvalHubClient>)
- [type EvalManifest](<#EvalManifest>)
  - [func ReadEvalManifest\(modelsPath, repositoryID string\) \(\*EvalManifest, error\)](<#ReadEvalManifest>)
- [type EvalProgressFunc](<#EvalProgressFunc>)
- [type EvalRelationship](<#EvalRelationship>)
- [type EvalSourceFile](<#EvalSourceFile>)
- [type EvalUpdateError](<#EvalUpdateError>)
- [type EvalUpdateResult](<#EvalUpdateResult>)
  - [func ReconcileEvals\(ctx context.Context, client EvalHubClient, modelsPath, repoID string\) \(EvalUpdateResult, error\)](<#ReconcileEvals>)
  - [func ReconcileEvalsWithProgress\(ctx context.Context, client EvalHubClient, modelsPath, repoID string, progress EvalProgressFunc\) \(EvalUpdateResult, error\)](<#ReconcileEvalsWithProgress>)
- [type EvalUpdateStatus](<#EvalUpdateStatus>)
- [type EvalUpdateSummary](<#EvalUpdateSummary>)
...
- [type HFCLIClient](<#HFCLIClient>)
  ...
  - [func \(c \*HFCLIClient\) DownloadFile\(ctx context.Context, modelID, revision, remotePath, localDir string\) \(string, error\)](<#HFCLIClient.DownloadFile>)
  - [func \(c \*HFCLIClient\) ListFiles\(ctx context.Context, modelID string\) \(string, \[\]ModelFile, error\)](<#HFCLIClient.ListFiles>)
  - [func \(c \*HFCLIClient\) ModelMetadata\(ctx context.Context, modelID string\) \(ModelMetadata, error\)](<#HFCLIClient.ModelMetadata>)
...
- [type ModelFile](<#ModelFile>)
  - [func EvalFiles\(files \[\]ModelFile\) \[\]ModelFile](<#EvalFiles>)
...
- [type NormalizedEvalBundle](<#NormalizedEvalBundle>)
- [type NormalizedEvalResult](<#NormalizedEvalResult>)
...
<a name="NormalizeModelIdentity"></a>
...
<a name="RemoveEvalBundleAtomic"></a>
## func RemoveEvalBundleAtomic
...
<a name="DiscoverPrimary"></a>
### func DiscoverPrimary
...
<a name="DiscoverSecondary"></a>
### func DiscoverSecondary
...
<a name="EvalDestination"></a>
## type EvalDestination
...
<a name="ResolveEvalDestination"></a>
### func ResolveEvalDestination
...
<a name="EvalHubClient"></a>
## type EvalHubClient

EvalHubClient is the Hub surface required by evaluation discovery. It is intentionally separate so existing model\-search callers and test doubles do not need to implement evaluation\-specific operations.
...
<a name="ReadEvalManifest"></a>
### func ReadEvalManifest
...
<a name="EvalProgressFunc"></a>
## type EvalProgressFunc

EvalProgressFunc receives human\-readable progress events during a refresh. Events are deliberately plain text so callers can render them for a terminal without coupling the model manager to a UI framework.

```go
type EvalProgressFunc func(string)
```

<a name="EvalRelationship"></a>
## type EvalRelationship
...
<a name="EvalRelationshipExactRepo"></a>
...
<a name="EvalUpdateError"></a>
## type EvalUpdateError
...
<a name="EvalUpdateResult"></a>
## type EvalUpdateResult
...
<a name="ReconcileEvalsWithProgress"></a>
### func ReconcileEvalsWithProgress
...
ReconcileEvalsWithProgress applies the same reconciliation policy as ReconcileEvals while reporting its current phase to the supplied callback.

<a name="EvalUpdateStatus"></a>
## type EvalUpdateStatus
...
<a name="EvalStatusCreatedPrimary"></a>
...
<a name="EvalUpdateSummary"></a>
## type EvalUpdateSummary
...
<a name="HFCLIClient.DownloadFile"></a>
### func \(\*HFCLIClient\) DownloadFile
...
<a name="HFCLIClient.ModelMetadata"></a>
### func \(\*HFCLIClient\) ModelMetadata
...
ModelMetadata contains the identity signals used for safe secondary eval inheritance.
...
<a name="NormalizedEvalBundle"></a>
## type NormalizedEvalBundle
