...
func TestMonitorModelLoadingReturnsToMetricsAfterLoaded(t *testing.T) {
	srv := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		_, _ = fmt.Fprintln(w, `data: {"model":"other-model","event":"status_change","data":{"status":"loading","progress":{"current":"text_model","value":0.5}}}`)
		_, _ = fmt.Fprintln(w, `data: {"model":"target-model","event":"status_change","data":{"status":"loading","progress":{"current":"text_model","value":0.5}}}`)
		_, _ = fmt.Fprintln(w, `data: {"model":"target-model","event":"status_change","data":{"status":"loaded"}}`)
	}))
	defer srv.Close()
